...
$GLOBALS['TL_LANG']['tl_social_feed']['linkedin_client_id'] = array("Client ID","Please enter the client id from your app.");
$GLOBALS['TL_LANG']['tl_social_feed']['linkedin_client_secret'] = array("Client Secret","Please enter the client secret from your app.");
$GLOBALS['TL_LANG']['tl_social_feed']['linkedin_company_id'] = array("Company Page ID","Please enter the company page id.");
$GLOBALS['TL_LANG']['tl_social_feed']['linkedin_access_token'] = array("Access Token","This is an auto-generated value that will be filled in when you submit the form.");
