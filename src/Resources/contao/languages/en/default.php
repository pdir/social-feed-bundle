...
$GLOBALS['TL_LANG']['BE_MOD']['socialFeedModerate']['twitterNotSupported'] = 'Twitter posts can\'t yet be imported into the news archive via the manual import. Please set up a cronjob in the social feed account and use the automatic import. Currently, only Instagram posts can be imported via the manual import.';
