...
use Pdir\SocialFeedBundle\Cron\InstagramImportCron;
 ...
 */
#[AsCommand(
    name: 'social-feed:instagram:import',
    description: 'Import Instagram posts from API.',
    aliases: ['sf:instagram']
)]
/**
 * Import Instagram posts.
 */
class InstagramImportCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $output->writeln('Social Feed: Run Instagram import ...');
