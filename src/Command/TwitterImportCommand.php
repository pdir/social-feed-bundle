...
use Pdir\SocialFeedBundle\Cron\TwitterImportCron;
 ...
 */
#[AsCommand(
    name: 'social-feed:x:import',
    description: 'Import Twitter posts from API.',
    aliases: ['sf:x']
)]
/**
...
class TwitterImportCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $output->writeln('Social Feed: Run Twitter import ...');
