...
$GLOBALS['TL_LANG']['tl_social_feed']['pdir_sf_fb_access_token'] = ['Access Token', 'Bitte Accountname, App ID und App Secret ausfüllen und anschließend speichern, um den Token anzufordern.'];
...
$GLOBALS['TL_LANG']['tl_social_feed']['psf_instagramAccessToken'] = ['Instagram Access Token', 'Bitte App ID und App Secret ausfüllen und anschließend speichern, um den Token anzufordern.'];
...
$GLOBALS['TL_LANG']['tl_social_feed']['psf_instagramImportMentions'] = ['Erwähnungen importieren', 'Aktivieren Sie diese Option um Erwähnungen zu importieren.'];
...
$GLOBALS['TL_LANG']['tl_social_feed']['linkedin_access_token'] = ['Access Token', 'Bitte Client ID, Client Secret und die ID der Unternehmensseite ausfüllen und anschließend speichern, um den Token anzufordern.'];
