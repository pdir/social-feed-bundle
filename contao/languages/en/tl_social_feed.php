...
$GLOBALS['TL_LANG']['tl_social_feed']['socialFeedAccountLegend'] = 'Account and authentication';
$GLOBALS['TL_LANG']['tl_social_feed']['socialFeedImportLegend'] = 'Import settings';
...
$GLOBALS['TL_LANG']['tl_social_feed']['pdir_sf_fb_access_token'] = ['Access Token', 'Please fill in the account name, App ID, and App Secret and save the record before requesting the token.'];
...
$GLOBALS['TL_LANG']['tl_social_feed']['psf_instagramAccessToken'] = ['Instagram access token', 'Please fill in the App ID and App Secret and save the record before requesting the token.'];
...
$GLOBALS['TL_LANG']['tl_social_feed']['psf_instagramImportMentions'] = ['Import mentions', 'Enable this option to import mentions.'];
...
$GLOBALS['TL_LANG']['tl_social_feed']['twitter_account'] = ['X account', 'Please enter the x account name (without @).'];
...
$GLOBALS['TL_LANG']['tl_social_feed']['linkedin_access_token'] = ['Access Token', 'Please fill in the Client ID, Client Secret, and the company page ID and save the record before requesting the token.'];
...
$GLOBALS['TL_LANG']['tl_social_feed']['linkedinImportSharedContent'] = ['Import shared posts?', 'Enable to import shared posts from the company page.'];
$GLOBALS['TL_LANG']['tl_social_feed']['noteForRefreshTokenMail'] = ['Note for Refresh Token E-Mail', 'Please specify here which domain or which note should be displayed in the Refresh Token E-Mail'];
...
$GLOBALS['TL_LANG']['tl_social_feed']['setupPlus'] = <<<HTML
  <h3>Social Feed<span class="high-plus"></span> Version</h3>
    ...
    <p><br><span class="price">99,- € inkl. MwSt.</span> <a href="https://pdir.de/socialfeed+?mtm_campaign=ExtensionSetup&mtm_content=en" target="_blank" class="tl_submit">Buy now</a></p>
HTML;
$GLOBALS['TL_LANG']['tl_social_feed']['setupFooter'] = 'Your team of <img src="/bundles/pdirsocialfeed/img/pdir_logo.svg" width="50" alt="pdir logo" style="vertical-align: sub;"> / digital agency';
